  ...
  const classes = [
    {
      ...
      year: 1,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/info1m.png`,
    },
    {
      name: 'Informática',
      year: 2,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/info2m.png`,
    },
    {
      name: 'Informática',
      year: 3,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/info3m.png`,
    },
    {
      name: 'Informática',
      year: 4,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/info4m.png`,
    },
    {
      name: 'Mecatrônica',
      year: 1,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/meca1m.png`,
    },
    {
      name: 'Mecatrônica',
      year: 2,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/meca2m.png`,
    },
    {
      name: 'Mecatrônica',
      year: 3,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/meca3m.png`,
    },
    {
      name: 'Mecatrônica',
      year: 4,
      turn: 'Matutino',
      path: `${Config.STATIC_FILES_URL}/files/horarios/meca4m.png`,
    },
  ];
